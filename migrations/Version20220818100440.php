 ...
 */
final class Version20220818100440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD user_id INT NOT NULL, CHANGE description description VARCHAR(2047) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer DROP user_id, CHANGE description description VARCHAR(255) NOT NULL');
